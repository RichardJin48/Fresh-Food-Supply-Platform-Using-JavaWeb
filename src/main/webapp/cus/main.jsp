...
<body>
    ...
    <div class="col-sm-6 col-sm-offset-3">
        <form class="form-horizontal" action="/product?opt=search&userName=${user.username}" method="post">
            <input type="text" class="form-control" name="keyword" placeholder="Please enter the product name">
            <input type="submit" value="Search" class="btn btn-success">
        </form>
    </div>
    <div class="col-sm-6 col-sm-offset-3">
        <h3 class="text-center" style="color:red;margin-top:30px;margin-bottom:10px">Announcement</h3>
        <h4 class="text-center" style="margin-top:10px;margin-bottom:10px">${ann.title}</h4>
        <h4 class="text-center" style="margin-top:10px;margin-bottom:10px">${ann.content}</h4>
    </div>
    <div class="col-sm-6 col-sm-offset-3">
        <h3 class="text-center" style="color:orange;margin-top:30px;margin-bottom:10px">Recommended Products</h3>
        <table class="table table-striped table-bordered">
            ...
            <c:forEach items="${p1}" var="product">
                <tr>
                    ...
                    <td>
                        <a href="/col?opt=addBeh2&productId=${product.productId}&userName=${user.username}" class="btn btn-info btn-sm">Favorite</a>
    ...
    <div class="col-sm-6 col-sm-offset-3">
        <h3 class="text-center" style="color:green;margin-top:30px;margin-bottom:10px">All Products</h3>
        <table class="table table-striped table-bordered">
            <tr>
                <th>Product Name</th>
                <th>Price</th>
