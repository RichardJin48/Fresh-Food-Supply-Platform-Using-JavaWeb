...
<!--                <span>2</span>-->
        ...
        <!-- search bar -->
        <form action="/product?opt=categorySearch&userName=${user.username}&category=${category}" method="post">
            <div class="search">
    ...
    <div class="search">
        <div class="wrapper">
            <div class="hd">
                <img src="../static/images/banner${category}.jpg" alt="" style="margin-left: 100px; margin-bottom: 20px">
                <h2>${cateName}</h2>
            </div>
