...
<body>
    ...
    <div class="col-sm-6 col-sm-offset-3">
        <h3 class="text-center" style="color:green;margin-top:30px;margin-bottom:10px">Search Results</h3>
        <table class="table table-striped table-bordered">
            ...
            <c:forEach items="${p}" var="product">
                <tr>
                    ...
                    <td>
                        <a href="/col?opt=addBeh3&productId=${product.productId}&userName=${user.username}&keyword=${keyword}" class="btn btn-info btn-sm">Favorite</a>
